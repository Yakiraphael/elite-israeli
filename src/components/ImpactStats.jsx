...
const STATS = [
  ...
  { value: '84%', label: 'שיפור במדדי חוסן מנטלי לאחר שנת השתתפות' },
  { value: '3.2x', label: 'עלייה בסיכויי שילוב במסגרת ספורטיבית תחרותית' },
  { value: '12K', label: 'נוער משתתף בתכניות ספורט טיפוליות בשנה' },
];
