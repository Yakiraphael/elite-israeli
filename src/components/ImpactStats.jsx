...
const STATS = [
  { value: '250K', label: 'בני נוער בסיכון בישראל' },
  { value: '1,050', label: 'מטופלים בשנה ע"י חסות הנוער' },
  { value: '3', label: 'עמודי תווך: שינוי · אמונה · רצון' },
  { value: '387', label: 'שעות תכנית שנתיות לנוער' },
  { value: '₪220M', label: 'תקציב שנתי חסות הנוער — ניצול חלקי' },
  { value: '2025', label: 'שנת השקה רשמית — קריית גת' },
];
