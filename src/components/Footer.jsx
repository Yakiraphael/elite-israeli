...
// פוטר ציבורי — פאנל פחם עמוק עם קו-זהב עליון, מדרגת שקיפות (GuideStar), מיתוג ופרטי קשר.
// משתמש בטוקנים הסמנטיים (bg-surface, text-ink, text-brand) לאחידות עם הדשבורדים.
export default function Footer() {
  return (
    <footer className="relative overflow-hidden bg-surface border-t border-hairline" dir="rtl">
      <div className="border-b border-hairline py-5 px-6">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-3 text-center">
          <span className="text-xs text-ink-muted font-semibold">שקיפות ומהימנות:</span>
      ...
      <div className="py-10 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <img src={LOGO} alt="עילית ישראלית" className="h-11 w-auto" />
          <div className="text-center">
            <p className="text-xs text-ink-faint">© 2025 עילית ישראלית (חלצ) · כל הזכויות שמורות</p>
            <p className="text-[10px] text-brand/70 mt-1 tracking-[0.3em] uppercase">שינוי · אמונה · רצון</p>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-right">
              <span className="text-xs text-brand font-bold block">טלפון</span>
