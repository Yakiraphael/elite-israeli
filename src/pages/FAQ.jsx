...
const FAQ_CATEGORIES = [
  ...
  },
  {
    ...
    questions: [
      ...
      { q: 'מהי עמלת התיווך של IEFA?', a: 'במערכת הבוגרים, IEFA יכולה לתפקד כסוכנות דיגיטלית. בעת העברה, המערכת גוזרת עמלה חוקית של 5% עד 10% מהחוזה או מדמי ההעברה — בדיוק כמו סוכן מסורתי, רק אוטומטי ושקוף.' },
  ...
  },
  {
    ...
    color: 'text-[#D4AF37]',
    questions: [
      { q: 'כמה עולה מנוי מועדון/סקאוטר?', a: 'מנוי B2B למועדונים עולה 1,500 ₪ בחודש. המנוי כולל גישה למערכת הסינון המתקדמת, צפייה בסרטוני ביצועים מלאים, ושימוש במנגנון הגשת ההצעות הרשמי (Transfer Hub).' },
      ...
      { q: 'האם יש דמי השבחה עתידיים?', a: 'על פי תקנון פיפ"א, האקדמיה זכאית לדמי סולידריות של עד 5% מהעברה עתידית של שחקן שהתאמן אצלנו בגילאי 12-23. זה נחתם מראש בחוזה ההצטרפות לפלטפורמה.' },
      { q: 'איך עובדות חסויות מסחריות?', a: 'מותגי ספורט יכולים להעניק חסות ל"נבחרת החודש" של IEFA (שחקנים עם הציון המנטלי הגבוה ביותר) או לפרסם בפורטל המאמנים והשחקנים באופן ממוקד.' },
    ],
  },
  {
    icon: ShieldCheck,
