...
const FAQ_CATEGORIES = [
  ...
  },
  {
    ...
    questions: [
      ...
      { q: 'מהי עמלת התיווך של IEFA?', a: 'עמלה חסרת תקדים של 2% בלבד מכל חוזה בוגר שנסגר דרך ה-Transfer Hub — במקום 10%-15% שגוזרים סוכנים מסורתיים. חלק מהעמלה נתרם ישירות לחל"צ לסבסוד רישום ובדיקות רפואיות לילדי הפריפריה.' },
